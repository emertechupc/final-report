...
![Alt text](assets/event-storming-1.png)
...
![Alt text](assets/event-storming-2.png)
...
![Alt text](assets/event-storming-3.png)
...
![Alt text](assets/candidate-context-discovery-1.png)

![Alt text](assets/candidate-context-discovery-2.png)
...
![Alt text](assets/domain-message-flows-modeling.png)
...
![Alt text](assets/bounded-context-canvases-1.png)

![Alt text](assets/bounded-context-canvases-2.png)

### Context Mapping

![Alt text](assets/context-mapping.png)
...
![Alt text](assets/sa-system-landscape-diagram.png)
...
![Alt text](assets/sa-context-level-diagram.png)
...
![Alt text](assets/sa-container-level-diagram.png)
...
![Alt text](assets/sa-deployment-diagram.png)